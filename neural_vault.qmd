...
## Karpathy's System vs. The Neural Vault {.smaller}

**Two independent approaches to the same problem — and where each one wins.**
...
Built independently before Karpathy's post, starting from a different problem: how to load context into an active session, not just store it.

**What AJ built independently:**

- **Two-layer memory split**: Claude's ambient memory (who you are) + Obsidian wiki (what you know)
- **Context Injection Protocol**: a formal prompt template — a structured handshake between your vault and the model
- **`COMMIT:` flag**: Claude marks insights worth saving mid-session
