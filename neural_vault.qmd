...
I built this independently: not how to store knowledge, but how to **load it into an active session**.

*What I built independently:*

::: {.fragment}
- **Two-layer memory split**: Claude's ambient memory + Obsidian wiki — Karpathy doesn't address this
:::
