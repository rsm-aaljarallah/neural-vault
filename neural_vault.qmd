...
**The `Meta/` folder is the key: it contains `About_Me.md` — a plain text file that tells the AI who you are.**

**Andrej Karpathy had the same idea: use the LLM to build and maintain a persistent wiki from raw sources.**

:::: {.columns style="font-size: 0.8em;"}

::: {.column width="38%"}
![](aj_karpathy_thinking.png){width="100%" fig-align="center" style="border-radius: 8px; margin-top: 4px;"}
<div style="font-size: 0.72em; color: #64748b; text-align: center; margin-top: 4px;">Abdullah & Karpathy — two people,<br>one problem, different solutions</div>
:::
